...
# File Paths
fastq_dir_path = datadir + '/covid/' + model_name + '/filtered-fastq/'
...
end_time = time.time()
print("COVID dataset fastq to fasta after basecalling execution time: %s seconds " % (end_time - start_time))
...
# File Paths
fastq_dir_path = datadir + '/viral/' + model_name + '/filtered-fastq/'
...
os.system("python " + convert_script_path + fastq_dir_path)
end_time = time.time()
print("VIRAL dataset fastq to fasta after basecalling execution time: %s seconds " % (end_time - start_time))
...
# File Paths
fastq_dir_path = datadir + '/sepsis/' + model_name + '/filtered-fastq/'
...
os.system("python " + convert_script_path + fastq_dir_path)
end_time = time.time()
print("SEPSIS dataset fastq to fasta after basecalling execution time: %s seconds " % (end_time - start_time))
